...
This is an exploratory network analysis of this [Citation-Network V1](https://www.aminer.org/citation) containing research citation data for 629,814 papers and 632.752 citations. I wanted to generate the most important papers in this dataset according to how often they were referenced by other papers. So I built a network in which every node was a single paper and every edge was a reference to another paper. I ran the PageRank algorithm on a subgraph of the data to determine which nodes were the most important. I also explored some additional properties of the dataset such as weakly connected components and betweenness centrality to facilitate further understanding of the citation data. 
