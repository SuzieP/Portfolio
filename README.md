...
#### [5. Data visualization of My Spotify Streaming History Feb. 2020 - Feb. 2021 scraped with the Spotify API and using Python and Tableau.](https://nbviewer.jupyter.org/github/SuzieP/Portfolio/blob/master/MySpotify.ipynb)
